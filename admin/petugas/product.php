...
<a href="?page=tambah_product" class="btn btn-success mb-2">Tambah Product +</a>
...
<div class="card-body">
    <table class="table">
        ...
        <tr>
            ...
            <td>
                <a href="?page=edit_produk&id=<?= $data['id_produk'] ?>" class="btn btn-primary">EDIT</a>
                <form action="../kontrol/kontrolProduk.php?aksi=delete" method="post" class="d-inline">
